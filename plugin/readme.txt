== Specials Plugin==
Contributors: Rachana Sai, Isha Thaker, Alistair DCruz
Author URL: http://phoenix.sheridanc.on.ca/~ccit2710

SHORT DESCRIPTION

Our file was designed for our prototype client El Burrito to display their weekly specials menu. Our file works as a widget that can be activated directly from the sidebar.
One can edit the specials menu from Wordpress without having to use actual code.
